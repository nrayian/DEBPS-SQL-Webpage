  ...
  <div class="grid-container">
    ...
    <div class="middle" style="background-color:#bbb;"><p>
        ...
        <h4>Full Name</h4>
          ...
          $sql="SELECT `first_name`, `last_name` FROM `customer` WHERE email_id='".$email."' AND password='".$password."'";
        ...
        <?php
          ...
          $sql="SELECT `email_id` FROM `customer` WHERE email_id='".$email."' AND password='".$password."'";
          $result=$conn->query($sql);
          $name=$result->fetch_assoc();
          echo $name['email_id'];
          ?>
        ...
        <?php
          ...
          $sql="SELECT `phone_number` FROM `customer` WHERE email_id='".$email."' AND password='".$password."'";
          $result=$conn->query($sql);
          $name=$result->fetch_assoc();
        ...
        <?php
          ...
          $sql="SELECT `address` FROM `customer` WHERE email_id='".$email."' AND password='".$password."'";
          $result=$conn->query($sql);
          $name=$result->fetch_assoc();
          echo $name['address'];
          ?>
        ...
        <?php
          ...
          $sql="SELECT `nationality` FROM `customer` WHERE email_id='".$email."' AND password='".$password."'";
          $result=$conn->query($sql);
          $name=$result->fetch_assoc();
