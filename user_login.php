...
<?php
  ...
  <div class="left" style="background-color:#aaa;"><p><img src="side1.jpg" alt="Forest" width="350" height="1000"></div>
    ...
    <p><a href="payment.php"><img src="LOGIN.png" alt="Forest" width="400" height="250">
    </a></p>
    ...
    <p><a href="bill_detail.php"><img src="Bill Details.jpg" alt="Bill Details" width="400" height="250">
    </a></p></div>  
